  ...
  'backbone',
   'text!templates/user/query/filterOpTpl.html'
	...
	generateFilterQuery: function(e){
		...
		filterQuery.coordrs = [23.563987128451217, -127.61718750000001, 49.439556958940855, -61.083984375];
		...
		if(mask == 3) filterQuery.maskMethod = 'map';
		if(mask == 4){
