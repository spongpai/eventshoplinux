...
public class Constant {
	...
	public static final String SELECT_DSMSTR_DSRES_QRY = "SELECT ds.dsmaster_id,ds.dsmaster_theme,ds.dsmaster_desc,ds.dsmaster_format,ds.dsmaster_title,dr.boundingbox,ds.dsmaster_access FROM Datasource_Master ds, Datasource_Resolution dr WHERE ds.dsmaster_id=dr.dsmaster_id";
	...
	public static final String SELECT_QRYMSTR_QRY = "SELECT query_id,query_name,boundingbox,query_status FROM Query_Master WHERE qid_parent IS NULL";
	public static final String SELECT_QRY_BYID = "SELECT query_name,boundingbox,query_status FROM Query_Master WHERE query_id=?";
	...
	// by Siripen	
	public static final String SELECT_DSRES_QRY = "SELECT dr.dsmaster_id,dr.datastream_name,dr.time_window,dr.latitude_unit,dr.longitude_unit,dr.boundingbox,resolution_type FROM Datasource_Resolution dr WHERE dr.dsmaster_id=?";
	public static final String SELECT_WRPR_QRY = "SELECT wr.wrapper_id,wr.wrapper_name,wr.wrapper_type,wr.wrapper_key_value,wr.bag_of_words,wr.visual_tran_mat,wr.visual_color_mat,wr.visual_mask_mat,wr.visual_ignore_since FROM Wrapper wr WHERE wr.wrapper_id=? ";
	...
	public static final String SELECT_DSMSR_QRY = "SELECT dm.dsmaster_id, dm.dsmaster_title,dm.dsmaster_creator FROM Datasource_Master dm";
